...
[![持续集成](https://github.com/frieren52/shopping-grpo-longhorizon/actions/workflows/ci.yml/badge.svg)](https://github.com/frieren52/shopping-grpo-longhorizon/actions/workflows/ci.yml)
...
> **学术与环境来源：**本项目使用阿里巴巴集团团队发布的
> [ShopSimulator: Evaluating and Exploring RL-Driven LLM Agent for Shopping Assistants](https://arxiv.org/abs/2601.18225)
> 作为环境与研究基础，官方代码和数据见
> [ShopAgent-Team/ShopSimulator](https://github.com/ShopAgent-Team/ShopSimulator)。
> 本仓库的 Environment v2.1、Reward v3 适配、训练流水线和实验结果属于独立工程实现，
> 不应与论文原始实验结果混用。
